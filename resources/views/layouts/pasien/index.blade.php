...
<div class="container">
    ...
    {{-- cek session ketika berhasil menambahkan data, akan muncul alert --}}
    @if (session()->has('key'))
        ...
        @endif
        {{-- untuk menghapus session ketika browser refresh --}}
        @php
            session()->forget('key');
        @endphp
    @endif
    {{-- akhir dari pengecekan session --}}
