...
class HomeController extends Controller
{
    ...
    private function getRekamMedisStatistics()
    {
        ...
        return [
            ...
            'jumlahRmBulanSekarang' => RekamMedis::whereBetween('tanggal', [$bulanIni->startOfMonth(), $bulanIni->endOfMonth()])->count(),
            'jumlahRmBulanMinSatu' => RekamMedis::whereBetween('tanggal', [$bulanMinSatu->startOfMonth(), $bulanMinSatu->endOfMonth()])->count(),
            'jumlahRmBulanMinDua' => RekamMedis::whereBetween('tanggal', [$bulanMinDua->startOfMonth(), $bulanMinDua->endOfMonth()])->count(),
        ];
    }
}
